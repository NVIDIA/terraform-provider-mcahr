...
Notice: NVIDIA Mission Control autonomous hardware recovery Terraform Provider was built using the [Terraform Plugin Framework v1.15.0](https://github.com/hashicorp/terraform-plugin-framework/releases/tag/v1.15.0).
...
Third-party software licenses and copyright notices for dependencies used in the NVIDIA Mission Control autonomous hardware recovery Terraform Provider are available in the [vendor](https://github.com/NVIDIA/terraform-provider-NVIDIA Mission Control autonomous hardware recovery/tree/main/vendor) directory.