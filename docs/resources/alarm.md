---
page_title: "NVIDIA Mission Control autonomous hardware recovery_alarm Resource - terraform-provider-mcahr"
subcategory: ""
description: |-
  Alarms are fully-customizable Metric or status checks that automatically trigger remediation Actions.
---

# NVIDIA Mission Control autonomous hardware recovery_alarm (Resource)
...
```tf
resource "NVIDIA Mission Control autonomous hardware recovery_alarm" "cpu_alarm" {
  name = "my_cpu_alarm"
