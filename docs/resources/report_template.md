---
page_title: 'NVIDIA Mission Control autonomous hardware recovery_report_template Resource - terraform-provider-mcahr'
subcategory: ''
description: |-
---

# NVIDIA Mission Control autonomous hardware recovery_report_template (Resource)
