---
page_title: "NVIDIA Mission Control autonomous hardware recovery_resource Resource - terraform-provider-mcahr"
subcategory: ""
description: |-
...
# NVIDIA Mission Control autonomous hardware recovery_resource (Resource)
...
```tf
resource "NVIDIA Mission Control autonomous hardware recovery_resource" "az_k8s" {
